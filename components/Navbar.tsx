      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex justify-between h-14 ${isMenuOpen ? 'pb-5' : ''}`}>
          ...
          <div className={`hidden md:flex items-center gap-1 ${isMenuOpen ? 'opacity-0' : 'opacity-100'}`}>
            <Link href='https://www.instagram.com/sa._.climbs' target='_blank' className='flex text-[#BFBFBF] rounded-full hover:shadow-lg hover:text-white p-0.5 hover:bg-gradient-to-br from-[#fdf497] via-[#fd5949] to-[#285AEB] via-[#d6249f]'>
              <InstagramIcon className="items-center h-6 w-6 m-0.5 " />
            </Link>
            <Link href='https://www.linkedin.com/in/lee-shuoan' target='_blank' className='flex text-[#BFBFBF] rounded-full hover:shadow-lg hover:text-white p-0.5 hover:bg-[#0A66C2]'>
              <LinkedInIcon className=" items-center h-6 w-6 m-0.5 " />
            </Link>
            <Link href='https://www.github.com/leeshuoan' target='_blank' className='flex text-[#BFBFBF] rounded-full hover:shadow-lg p-0.5 hover:text-black hover:bg-[#F5F7F9] dark:hover:bg-[#30363D] dark:hover:text-white'>
