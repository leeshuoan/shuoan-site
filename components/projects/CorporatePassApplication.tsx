  ...
  return (
    <>
      ...
      <div className="col-span-6 mt-16">
        ...
        <p className="text-xs text-[#4C4C4C] dark:text-[#BFBFBF] italic">Supported by Singapore Sports School</p>
        ...
        <div className="flex mt-1">
          <div className="text-xs px-2 py-1 bg-[#3A8A81] bg-opacity-25 text-[#4C4C4C] dark:text-[#BFBFBF] rounded-lg m-1 ml-0  transition-all duration-300">Spring</div>
