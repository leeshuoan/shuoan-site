      ...
      <div className="md:grid md:grid-cols-12 gap-8 sm:mt-16 ">
        ...
        <div className="col-span-4 mt-3 md:mt-0">
          ...
          <p className="text-xs text-shuoan-light dark:text-shuoan-dark italic">
            Supported by Singapore Sports School
          </p>
          <p className="text-sm text-shuoan-light dark:text-shuoan-dark mt-2">
            A corporate pass application system that allows for staff to apply
            for corporate passes. The system manages corporate pass bookings and
            is able to generate booking confirmation and email reminders emails.
            It is also able to dynamically generate PDF invoices for each
            corporate pass booking.
          </p>
          ...
          <p className="text-sm font-semibold mt-3 ">
            <Link
              href="https://github.com/leeshuoan/corporate-pass-application"
              target="_blank"
