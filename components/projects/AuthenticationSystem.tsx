    ...
    <>
      ...
      <div className="col-span-6 mt-16">
        ...
        <p className="text-sm font-semibold mt-3 ">
          <a href='https://github.com/leeshuoan/authentication-system' target="_blank" className="flex items-center text-[#4C4C4C] dark:text-[#BCBCBC] hover:text-[#4DBBAC] dark:hover:text-[#4DBBAC]" >
            <GithubIcon className='h-8 w-8' />Github Repository
          </a>
          <a href='documents/authentication-system.pdf' target="_blank" className="flex items-center mt-1 ml-1 text-[#4C4C4C] dark:text-[#BCBCBC] hover:text-[#4DBBAC] dark:hover:text-[#4DBBAC]" >
