    ...
    <>
      ...
      <div className="md:grid md:grid-cols-12 gap-8 sm:mt-16 ">
        ...
        <div className="col-span-4 mt-3 md:mt-0">
          ...
          <p className="text-xs text-shuoan-light dark:text-shuoan-dark italic">
            Supported by Ascenda Loyalty
          </p>
          <p className="text-sm text-shuoan-light dark:text-shuoan-dark mt-2">
            Leveraging AWS Cloud security best practices, this custom
            authentication service is able to enrol customers and provide
            account ownership verification. Custom user authentication via a
            Hosted Login and the SSO of partnered bank&#39;s is available and
            secured with the signing and encryption of JWTs. Management of user
            roles and permissions is done through an admin control panel and
            JWKS Endpoints are included for communication with partner’s backend
            services
          </p>
          ...
          <p className="text-sm font-semibold mt-3 ">
            <Link
              href="https://github.com/leeshuoan/authentication-system"
              target="_blank"
            ...
            <Link
              href="documents/authentication-system.pdf"
              target="_blank"
