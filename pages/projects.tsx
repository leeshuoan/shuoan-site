...
const projects = () => {
  return (
    <>
      ...
      <p className="text-base text-center text-[#4C4C4C] dark:text-[#BFBFBF] mb-20">View more projects at my <a href="https://github.com/leeshuoan" target='_blank' className="font-semibold hover:text-[#4DBBAC] dark:hover:text-[#4DBBAC]">Github</a>!</p>
    </>
  );
};
