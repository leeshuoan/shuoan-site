    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fadeIn">
        <div className="h-[calc(100vh-3.5rem)] pb-16 flex items-center">
          <div>
            <p className="text-2xl md:text-3xl text-black dark:text-[#B4B4B4]">LEE SHUOAN</p>
            ...
            <p className="text-base text-[#4C4C4C] dark:text-[#B4B4B4]">
            ...
            <div className="mt-7 text-base">
              <Link
                href="/about"
                className="relative px-2 p-1 text-[#4C4C4C] dark:text-[#B4B4B4] dark:hover:text-black font-semibold group transition-all duration-300 ease-in-out border border-[#4C4C4C] hover:text-white "
              >
