        ...
        <div className='h-[calc(100vh-3.5rem)] pb-16 flex items-center'>
          <div className=''>
            ...
            <div className='mt-7 text-md'>
              <Link href="/about" className="relative px-2 p-1 text-[#656565] dark:text-[#C3C3C3] dark:hover:text-black font-semibold group transition-all duration-300 ease-in-out border border-[#656565] hover:text-white hover:shadow-md ">
              ...
              <Link href="/projects" className="relative px-2 p-1 text-[#656565] dark:text-[#C3C3C3] dark:hover:text-black font-semibold group transition-all duration-300 ease-in-out border border-[#656565] hover:text-white hover:shadow-md ">
                <span className="relative z-[1]">Projects</span>
                <span className="absolute inset-0 w-0 bg-[#5EA9BF] group-hover:w-full transition-all"></span>
              </Link>
              <Link href="/blog" className="relative px-2 p-1 text-[#656565] dark:text-[#C3C3C3] dark:hover:text-black font-semibold group transition-all duration-300 ease-in-out border border-[#656565] hover:text-white hover:shadow-md ">
