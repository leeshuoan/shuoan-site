      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-[calc(100vh-3.5rem)] pb-16 flex items-center">
          <div className="">
            ...
            <p className="text-md text-[#656565] dark:text-[#A5A5A5]">
            ...
            <div className="mt-7 text-md">
              <Link
                href="/about"
                className="relative px-2 p-1 text-[#656565] dark:text-[#A5A5A5] dark:hover:text-black font-semibold group transition-all duration-300 ease-in-out border border-[#656565] hover:text-white "
              >
