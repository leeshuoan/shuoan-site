        ...
        <a href="https://medium.com/@shuoan/scaling-machine-learning-with-ray-io-and-aws-34e7a00f90b0" target='_blank'>
          <div className="group px-3 py-3 hover:bg-[#F5F7F9] dark:hover:bg-[#2D333A] hover:shadow-md rounded-lg overflow-hidden w-full transition-[all] duration-300 ease-in-out">
            <div className="block md:flex">
              <img src='images/aws-ray-cluster.svg' className='object-fill sm:w-1/6' />
              <div className='sm:ml-3 sm:w-5/6'>
                <div className="text-xl font-semibold text-[#4C4C4C] dark:text-[#BFBFBF] group-hover:text-[#3A8A81] group-hover:dark:text-[#4DB8AC]">
                  Scaling Machine Learning with Ray.io and AWS
                </div>
                <div className="text-xs italic text-[#4C4C4C] dark:text-[#BFBFBF]">
                ...
                <div className='flex'>
                  <div className="text-xs px-2 py-1 bg-[#3A8A81] bg-opacity-25 text-[#4C4C4C] dark:text-[#BFBFBF] rounded-lg mt-2 mr-1">AWS</div>
                  <div className="text-xs px-2 py-1 bg-[#3A8A81] bg-opacity-25 text-[#4C4C4C] dark:text-[#BFBFBF] rounded-lg mt-2 mr-1">Distributed Computing</div>
                </div>
              </div>
            </div>
          </div>
