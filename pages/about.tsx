    ...
    <>
      ...
      >
        ...
        <div className="md:ml-20 md:col-span-9">
          ...
          <div className="text-base text-[#4C4C4C] dark:text-[#BFBFBF] px-3 md:pl-5">
          ...
          <div className="mb-14 group hover:bg-[#F5F7F9] dark:hover:bg-[#2D333A] hover:shadow-lg rounded-lg overflow-hidden w-full transition-[all] duration-300 ease-in-out">
            <div className="px-3 md:px-5 py-2">
              <div className="flex">
                <div className="text-sm font-semibold text-[#BFBFBF] min-w-[5.6rem] dark:text-opacity-60 dark:text-[#BFBFBF]">
                  2020-2024
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5">
                    <li className="text-sm text-[#4C4C4C] dark:text-[#BFBFBF] mt-2">
                      SCIS Dean&#39;s List AY2021/22
                    </li>
                    <li className="text-sm text-[#4C4C4C] dark:text-[#BFBFBF] mt-1">
